...
const MERCH_DATA = [
  { id: 1, name: "Áo Phông PawLink Classic", type: "apparel", emoji: "👕", price: 250000, desc: "Unisex, cotton 100%, in lưới cao cấp. Màu kem & xanh rừng.", badge: "Bán chạy nhất", bgColor: "#E8F0FF" },
  ...
  { id: 4, name: "Bộ Sticker PawLink Vol.1", type: "sticker", emoji: "🎨", price: 45000, desc: "12 sticker chống nước. Thiết kế chibi mèo chó cute.", badge: "45K", bgColor: "#FFF8E0" },
  ...
  { id: 6, name: "Nón Bucket PawLink", type: "apparel", emoji: "🧢", price: 220000, desc: "Chất liệu chống nắng tốt. Thêu logo PawLink 3D.", badge: "Limited", bgColor: "#E8F5FF" },
  ...
  { id: 8, name: "Gối Tựa Lưng Mochi", type: "homeware", emoji: "🛋️", price: 320000, desc: "Gối bông cao su non. In hình Mochi — mèo được cứu hộ đầu tiên của PawLink.", badge: "Story", bgColor: "#E8FFF5" },
...
function openCart() {
  ...
  if (cart.length === 0) {
    ...
    footer.innerHTML = `
      ...
      <div class="cart-note">🌿 ${formatPrice(donate30)} (30%) sẽ vào quỹ cứu hộ PawLink</div>
...
function checkout() {
  ...
  showToast("🎉 Đặt hàng thành công! Cảm ơn bạn đã ủng hộ PawLink!");
}
...
function openPartnerModal() {
  showToast("📧 Vui lòng liên hệ hello@pawlink.vn để hợp tác!");
}
